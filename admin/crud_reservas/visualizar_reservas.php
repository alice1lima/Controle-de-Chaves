...
$sql_total = "SELECT COUNT(*) as total FROM tb_reservas";
...
// Consulta SQL para selecionar todas as reservas e incluir detalhes do usuário e da sala
$sql = "SELECT 
            r.id_reserva, 
            r.entrada_previsao, 
            r.saida_previsao, 
        ...
        WHERE YEARWEEK(r.entrada_previsao, 1) = YEARWEEK(CURDATE(), 1)
...
<body>
    ...
    <table border='1' id='userTable'>
        <tr>
            <th style='background-color: white;'>Nome do Usuário</th>
            ...
            <th style='background-color: white;'>Data de Reserva</th>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        $dh_reserva = new DateTime($row["dh_reserva"]);
        ...
        echo "<tr>
                ...
                <td>" . $dh_reserva->format('d/m/Y H:i:s') . "</td>
