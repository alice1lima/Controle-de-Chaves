...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Verificar se há conflitos com outras reservas
    ...
    if ($result_verificar_conflito->num_rows > 0) {
        echo "<script>alert('Já existe uma reserva para esta sala no período selecionado.');</script>";
    } else {
        // Inserir a nova reserva no banco de dados
        $sql_insert = "INSERT INTO tb_reservas (id_sala, id_usuario, entrada_previsao, saida_previsao, eh_aprovada) 
                       VALUES ('$id_sala', '$id_usuario',  '$entrada_previsao', '$saida_previsao', '$eh_aprovada')";
...
// Recuperar dados dos usuários exceto aqueles com o cargo "ASG"
$sql_usuarios = "
...
<div class="header-container">
   ...
   <div id="popup" class="popup-container">
    ...
    <a href="../crud_reservas/cadastrar_reservas.php">Cadastrar Reservas</a>
...
<div class="form-container">
        ...
        <p>
            <input type="checkbox" name="eh_aprovada" value="1"> Aprovada
        </p>
