...
$sql_total = "SELECT COUNT(*) as total FROM tb_cargos";
...
$sql = "SELECT id_cargo, cargo FROM tb_cargos LIMIT $offset, $itens_por_pagina";
...
<div class="nav-links">
    <a href="../index_admin.php">Início</a>
    <a href="../crud_cargo/cadastrar_cargo.php">Cadastrar Cargos</a>
...
if ($result->num_rows > 0) {
    echo "<table border='1' id='userTable'>
            <tr>
                <th style='background-color: white;'>Nome do Cargo</th>
                <th style='background-color: white;'>Ação</th>
            </tr>";
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                <td>" . $row["cargo"] . "</td>
                <td>
                    <a href='atualizar_cargo.php?id_cargo=" . $row["id_cargo"] . "'><i class='bi bi-pencil-square' style='font-size: 25px;'></i></a> 
                </td>
            </tr>";
    }
    echo "</table>";
    ...
    for ($i = 1; $i <= $total_paginas; $i++) {
        ...
        echo "<li class='page-item $active'><a class='page-link' href='visualizar_cargo.php?pagina=$i'>$i</a></li>";
    }
    echo "</ul>
          </nav>";
} else {
