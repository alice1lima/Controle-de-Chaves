...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $bloco = $conn->real_escape_string($_POST['bloco']);

    $sql_insert = "INSERT INTO tb_salas (sala, bloco) VALUES ('$sala', '$bloco')";
...
<div class="header-container">
   ...
   <div id="popup" class="popup-container">
    ...
    <a href="visualizar_sala.php">Visualizar Sala</b></a>
...
<div class="form-container">
    <form action="" method="post">
        <h4>Sala:</h4>
            <input type="text" name="sala" required placeholder="Ex. Sala 0">
        
        <h4>Bloco:</h4>
            <input type="text" name="bloco" required placeholder="Ex. Bloco 1">
