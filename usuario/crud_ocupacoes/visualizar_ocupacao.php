...
$sql_total = "SELECT COUNT(*) as total FROM tb_ocupacoes WHERE id_usuario = $id_usuario_sessao";
...
// Consulta SQL para selecionar as ocupações do usuário logado com paginação
$sql = "SELECT 
            o.id_ocupacao, 
            o.dh_entrada, 
            o.dh_saida, 
        ...
        WHERE o.id_usuario = $id_usuario_sessao
...
<head>
    ...
    <title>Visualizar Ocupações</title>
</head>
<body>
    ...
    <table border="1" id="userTable">
        <tr>
            <th style='background-color: white;'>Usuário</th>
            ...
            <th style='background-color: white;'>Observações</th>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <td>
                            <a href='editar_ocupacao.php?id_ocupacao=" . $row["id_ocupacao"] . "'><i class='bi bi-pencil-square' style='font-size: 25px;'></i></a>
                        </td>
                    </tr>";
            }
        } else {
            echo "<tr><td colspan='8'>Nenhuma ocupação encontrada.</td></tr>";
        }
        ?>
    </table>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            for ($i = 1; $i <= $total_paginas; $i++) {
                ...
                echo "<li class='page-item $active'><a class='page-link' href='visualizar_ocupacao.php?pagina=$i'>$i</a></li>";
            }
            ?>
        </ul>
    </nav>
